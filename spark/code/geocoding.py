...
def fetchDataset():
    ...
    headers = {
        ...
        'X-Parse-Master-Key': 'iyzSAHUmPKUzceWRIIitUD1OKAGHvVUzEYb5DCpj' # This is the fake app's readonly master key
    }
...
def getLocationAsString(cityname):
    ...
    if location == False:
        return False
    return f"{'%.5f' % location['latitude']},{'%.5f' % location['longitude']}"
